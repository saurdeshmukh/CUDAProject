...
__global__ void k_bounding_algorithm(Point2D * points,int n,int k,int *finalArea,int *minArea)
{
...
int main(void)
{
   ...
   cudaDeviceSynchronize();
    ...
    cudaEventRecord(seq_start);
    k_bounding_algorithm<<<blocksPerGrid,threadsPerBlock>>>(d_points,n,k,d_minArea,d_Area);
